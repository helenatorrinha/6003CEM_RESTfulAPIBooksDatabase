 ...
 * @description Configures authorisation rules using the role-acl library, defining roles and their permissions for the books model.
 * @requires role-acl
 ...
 * @see models/books for the database functions
 */
...
/** User Permissions
 * Grants 'user' role permissions to readNone books (no permissions).
...
/** Admin Permissions
 * Grants 'admin' role permissions to create, update and delete books.
 * Allows actions: 'create', 'update', 'delete'.
 * Denies actions: none.
 * In this case, we are excluding the book_id field from the update permission check.
 */
 ...
 * @throws {Error} Throws an error if the user does not have permission to create a new book
 */
 ...
 * @returns {object} - The result of the authorisation check
 * @throws {Error} Throws an error if the user does not have permission to update the book
 */
 ...
 * @returns {object} - The result of the authorisation check
 * @throws {Error} Throws an error if the user does not have permission to delete the book
 */
